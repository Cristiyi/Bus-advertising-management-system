...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px; margin: 10px 5px;font-algin:center">
            <table class="table table-striped table-hover" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr id="order">
                        ...
                        <td><a href="<?php echo U('Adver/tianjia');?>"><button type="button" class="btn btn-warning"><i class="fa fa-pencil"></i>修改</button></a></td>
                        <td><a href="/zjkgj/gongjiao/index.php/Back/Order/delOrder/orderid/<?php echo ($v["orderid"]); ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i>删除</button></a></td>
