...
<html>
    ...
    <body>
        ...
        <div class="div_head">
            <span>
                <span style="float:left">当前位置是：广告管理-》添加广告</span>
        ...
        <div style="font-size: 13px;margin: 10px 5px" class="form-group">
            <form action="/zhangjiakou/bus/index.php/Back/Adver/tianjia.html" method="post" enctype="multipart/form-data">
            <table width="100%" class="table table-striped">
                ...
                <tr>
                    <td>广告位图片</td>
                    <td><input type="file" name="adverimg" /></td>
                </tr>
                <tr>
