            ...
            <table class="table table-striped table-hover" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <?php if(is_array($info)): foreach($info as $key=>$v): ?><tr id="place">
                        ...
                        <td><a href="/zhangjiakou/bus/index.php/Back/Place/delPlace/placeid/<?php echo ($v["placeid"]); ?>" onclick="return confirm('确定删除这个广告吗？')"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i>删除</button></a></td>
