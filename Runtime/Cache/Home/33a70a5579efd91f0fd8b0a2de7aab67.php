  ...
  <div class="full-width-wrapper" id="abstract-bg"><!--Banner-->
	...
	<div class="fixed-width-wrapper border-radius-5px" id="navigation-bar">
		<div id="g-navigation"><ul class="simple-drop-down-menu">
		  ...
		  <li><a href="<?php echo U('Service/service');?>" title="">广告预约</a>
			<ul>
			   <li><a href="<?php echo U('Chenei/showlist');?>" title="">标准媒体</a></li>
			   <li><a href="services1.html" title="">超级媒体</a></li>

		    </ul>
		  </li>
		  <li><a href="<?php echo U('Youshi/youshi');?>" title="">媒体优势</a></li>
		  <li><a href="<?php echo U('Blog/blog');?>" title="">媒体资源</a>
   ...
   <!--中部图片-><!--Slider-->
	...
	<span class="STYLE10">关于我们</span>
	  <div class="content"><a href="#" title="" class="preloading-light img-border align-none"><img src="<?php echo (C("IMG_URL")); ?>/sy7.png" width="270" alt=""></a>
 ...
 <div class="block type1">
	<span class="STYLE10">为什么选择我们</span>
	  <div class="content" width="250">
	    <a href="#" title="" class="preloading-light img-border align-none"><img src="<?php echo (C("IMG_URL")); ?>/sy6.png" width="270" alt=""></a>
