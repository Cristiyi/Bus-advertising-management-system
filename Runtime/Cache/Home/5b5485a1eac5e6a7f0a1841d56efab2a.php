...
<body>
  ...
  <h3 class="list-group">站牌广告</h3>
  <div class="img1"><img class="media-object" alt="" width="500" height="300" src="<?php echo (C("IMG_URL")); ?>/zhanpai1.jpg"></div>
  <div class="img2"><img class="media-object" alt="" width="500" height="300" src="<?php echo (C("IMG_URL")); ?>/zhanpai2.jpg"></div>
  <div class="list-group">
    ...
    <div class="media">
      ...
      <div class="media-body">
        ...
        <?php if(is_array($info)): foreach($info as $key=>$v): ?><a href="" class="list-group">
