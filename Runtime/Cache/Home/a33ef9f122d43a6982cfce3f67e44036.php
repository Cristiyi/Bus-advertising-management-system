...
<div class="mid">
  <div class="danei mid">
  <div class="midimage"><img src="<?php echo (C("IMG_URL")); ?>/blog1.png" width="980" height="300" /></div>
    <div class="con_left">
      <ul>
    ...
    <div class="con_right">
	  ...
	  <div class="biaozhun_image"><img src="<?php echo (C("IMG_URL")); ?>/dianwei.png"  /></div>
	  <div class="right_title">武汉合作伙伴</div>
	  <div class="biaozhun_image"><img src="<?php echo (C("IMG_URL")); ?>/hezuo.png"  /></div>
	<!--/中部开始  <div class="tpwz">-->
