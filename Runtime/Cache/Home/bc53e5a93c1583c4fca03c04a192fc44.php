...
<div class="mid">
  <div class="danei mid">
  <div class="midimage"><img src="<?php echo (C("IMG_URL")); ?>/ys1.png" width="980" height="300" /></div>
    <div class="con_left">
      <ul>
	...
	<!--/中部开始  <div class="tpwz">-->
	  ...
	  <ul>
	     ...
	     <li><span class="STYLE8"><img src="<?php echo (C("IMG_URL")); ?>/li2.png" width="70" height="40">1.广告受众质量高:</span>均为市区最具消费能力的中高收入群体。</li>
		 <li><span class="STYLE8"><img src="<?php echo (C("IMG_URL")); ?>/li2.png" width="70" height="40">2.选择性和针对性强:</span>根据广告主对其广告受众的选择，道闸广告直接将广告信息传递给真正的受众，具有强烈的选择性和针对性。</li>
         <li><span class="STYLE8"><img src="<?php echo (C("IMG_URL")); ?>/li2.png" width="70" height="40">1.广告持续时间长:</span>一个30秒的电视广告，它的信息在30秒后荡然无存。道闸广告则明显不同，在受传者作出最后决定之前，可以反复多次读取广告信息。 </li>
         <li><span class="STYLE8"><img src="<?php echo (C("IMG_URL")); ?>/li2.png" width="70" height="40">1.具有强迫受众读取的特性:</span>不同于报纸杂志广告，道闸广告信息直接面对着进出大门的司机和行人，可以无限次进入他们的眼球从而影响其购买行为。</li>
		 <li><span class="STYLE8"><img src="<?php echo (C("IMG_URL")); ?>/li2.png" width="70" height="40">1.高效的广告传播:</span>在投放广告之前，可以参照小区人口统计因素和地理区域因素选择受传对象以保证最大限度地使广告讯息为受传对象所接受，真正作到有的放矢。每天平均5次的阅读频次，广告信息准确、集中、反复地定向传播。</li>
		 <li><span class="STYLE8"><img src="<?php echo (C("IMG_URL")); ?>/li2.png" width="70" height="40">1.具有可测定性:</span>发布广告之后，可以借助产品销售数量的增减变化情况及变化幅度来了解广告信息传出之后产生的效果，从而选择以后的投放小区。这一优势超过了其他广告媒体。</li>
