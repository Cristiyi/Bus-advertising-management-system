...
<body>
  ...
  <h3 class="orderlist">车身广告</h3>

  <div class="img1"><img class="media-object" alt="" width="500" height="300" src="<?php echo (C("IMG_URL")); ?>/cheshen11.jpg"></div>
  <div class="img2"><img class="media-object" alt="" width="500" height="300" src="<?php echo (C("IMG_URL")); ?>/cheshen22.jpg"></div>
  ...
  <div class="list-group">
    ...
    <div class="media">
      ...
      <div class="media-body">
        <!-- <h3 class="media-heading">车身广告</h3> -->
        <?php if(is_array($info)): foreach($info as $key=>$v): ?><a href="" class="orderlist">
        <h4 ng-if="message"><?php echo ($v["description"]); ?></h4>
        <p>
