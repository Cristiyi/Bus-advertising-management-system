...
<div class="mid">
  <div class="danei mid">
  <div class="midimage"><img src="<?php echo (C("IMG_URL")); ?>/sub1.png" width="980" height="300" /></div>
    <div class="con_left">
      <ul>
        <li><a href="services.html" style="font-weight:bold;">车身广告</a></li>
        <li><a href="services1.html" >车内广告</a></li>
        <li><a href="services1.html" >站牌广告</a></li>
    ...
    <div class="con_right">
	  ...
	  <div class="biaozhun_image"><img src="<?php echo (C("IMG_URL")); ?>/bzdz.png"  /></div>
	<!--/中部开始  <div class="tpwz">-->
	  <div class="jianjie">
	  <ul>
